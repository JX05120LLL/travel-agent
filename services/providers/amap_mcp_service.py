...
from services.core.errors import ServiceConfigError, ServiceIntegrationError, ServiceValidationError
...
class AmapMcpService:
    ...
    def __init__(self, amap_service: AmapService | None = None) -> None:
        ...
        if configured_url:
            ...
            self.mcp_url = ""
        self.timeout_seconds = float(os.getenv("AMAP_MCP_TIMEOUT_SECONDS", "45") or "45")
